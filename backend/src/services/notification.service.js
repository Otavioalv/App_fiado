...
var notify_1 = require("../sockets/events/notify");
...
var NotificationService = /** @class */ (function () {
    function NotificationService(app) {
        ...
        this.app = app;
        this.notifier = (0, notify_1.notify)(app);
    }
    NotificationService.prototype.saveAndSendPrepared = function (notification, inputNot) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.notificationModel.saveNotification(saveData)];
                    case 1:
                        _a.sent();
                    ...
                    case 2:
                        err_1 = _a.sent();
                        console.log("saveAndSendPrepared: ", err_1);
