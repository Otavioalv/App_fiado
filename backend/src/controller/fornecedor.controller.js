...
var FornecedorController = /** @class */ (function (_super) {
    __extends(FornecedorController, _super);
    function FornecedorController() {
        ...
        _this.notificationModel = new notification_model_1.NotificationModel();
        _this.validateDatasUser = new ValidateDatasUser_1.ValidateDatasUser();
        return _this;
    }
    FornecedorController.prototype.register = function (req, res) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.validateDatasUser.validateDatasFornecedor(datasRegister)];
                    case 2:
                        message = _b.sent();
                        if (!datasRegister) {
                        ...
                        return [4 /*yield*/, this.fornecedorModel.userExists(datasRegister.nome)];
                    case 3:
                        if (_b.sent()) {
                    ...
                    case 4:
                        _a.senha = _b.sent();
                        return [4 /*yield*/, this.fornecedorModel.register(datasRegister)];
                    case 5:
                        _b.sent();
    ...
    FornecedorController.prototype.login = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var datasLogin, message, hashedPass, token, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.fornecedorModel.userExists(datasLogin.nome)];
                    case 3:
                        if (!(_a.sent())) {
                            return [2 /*return*/, res.status(404).send((0, api_response_1.errorResponse)(responseApi_1.ResponseApi.Auth.INVALID_CREDENTIALS))];
                        }
                        return [4 /*yield*/, this.fornecedorModel.getPasswordUsingUser(datasLogin.nome)];
                    case 4:
                        hashedPass = _a.sent();
                    ...
                    case 7:
                        err_2 = _a.sent();
                        return [2 /*return*/, res.status(500).send((0, api_response_1.errorResponse)(responseApi_1.ResponseApi.Server.INTERNAL_ERROR, err_2))];
                    case 8: return [2 /*return*/];
                }
            });
        });
    };
    FornecedorController.prototype.listAll = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var filterOpt, idCliente, list, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.fornecedorModel.listAll(idCliente, filterOpt)];
                    case 3:
                        list = _a.sent();
    ...
    FornecedorController.prototype.partnerList = function (req_1, res_1) {
        return __awaiter(this, arguments, void 0, function (req, res, typeList) {
            var filterOpt, id, listPartner, e_2;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        if (!(_a.sent()))
                            return [2 /*return*/, res.status(400).send((0, api_response_1.errorResponse)(responseApi_1.ResponseApi.Validation.INVALID_FILTER))];
                        if (!id) {
                            return [2 /*return*/, res.status(404).send((0, api_response_1.errorResponse)(responseApi_1.ResponseApi.Partner.LIST_ERROR))];
                        }
                        return [4 /*yield*/, this.clienteModel.getPartnerByIdFornecedor(id, typeList, filterOpt)];
                    case 3:
                        listPartner = _a.sent();
    ...
    FornecedorController.prototype.generateTokenUser = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var fornecedor, payload, token, e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.fornecedorModel.findByUsername(user.nome)];
                    case 1:
                        fornecedor = _a.sent();
